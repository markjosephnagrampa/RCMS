<?php
	...
	if(!isset($_SESSION["User"])){
		...
		if($_SESSION["User"]["UserType"] != 2){
			...
			if(!isset($_POST["ManageTables"])){
				header("Location: ManageTables_action_page.php");
			}
		}
	}
?>
...
<html lang="en">
	<head>
		<title>RCMS | Manage Tables</title>
		<meta charset="utf-8">
	...
	<body>
		<form action = "ManageTables_action_page.php" method = "post" enctype="multipart/form-data">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav" style = "text-align: center;">
						...
						<li class = "active"><a href="ManageTables.php">Manage Tables</a></li>
					</ul>
		...
		<div class = "row">
			<div class = "col-sm-offset-2 col-sm-8">
				<div class="panel panel-default">
					<div class="panel-heading"><span style = "font-weight: bold; font-size: 1.25em;">Table List</span></div>
		...
		<span class = "font-size: 1.5em";>&nbsp;</span>
		<div class = "row">
			<div class = "col-sm-offset-4 col-sm-4">
				<div class="panel panel-default">
					<div class="panel-heading"><span style = "font-weight: bold; font-size: 1.25em;">New Table</span></div>
					<div class="panel-body">
							<div class="form-group row">
								<div class = "col-sm-5">
									<label class="control-label" for="TableSeatingCapacity">Seating Capacity:</label>
								</div>
								<div class="col-sm-7">
									<input type="number" min = "1" name = "TableSeatingCapacity" class="form-control" id="TableSeatingCapacity" placeholder="Enter capacity">
								</div>
							</div>
							<div class="form-group" style = "text-align: center;">
								<button type="submit" name = "Add_Table" value "Add_Table" class="btn btn-success btn-lg">Add Table</button>
							</div>
					</div>
				</div>
				<div class = "col-sm-4">
