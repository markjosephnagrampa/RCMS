				...
				<div class="panel-body">
					<form action = "MyProfile_action_page.php" method="post" enctype="multipart/form-data" class="form-horizontal">
						<div class = "form-group">
							<div class = "col-sm-offset-4 col-sm-8"><img id = "output"
							...
							class="img-responsive img-circle" style = "max-height: 400px; max-width: 400px;"></div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Position:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="email" placeholder="Branch Manager" disabled>
							</div>
						</div>
						<div class="form-group">
